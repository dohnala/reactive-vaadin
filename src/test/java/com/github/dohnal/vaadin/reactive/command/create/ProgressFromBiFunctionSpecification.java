 ...
 * {@link ReactiveCommandExtension#createProgressCommand(BiFunction, Scheduler)}
 * {@link ReactiveCommandExtension#createProgressCommand(Observable, BiFunction, Scheduler)}
 *
 * @author dohnal
 */
...
{
    abstract class AbstractProgressFromBiFunctionWithSchedulerSpecification extends
